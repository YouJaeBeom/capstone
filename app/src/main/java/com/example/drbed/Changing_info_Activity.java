...
public class Changing_info_Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_changing_info_);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.changing_info_, menu);
        ...
        User_Info_text.setText("이름:"+Name+"\n"+"전화번호:"+Phone);
        return true;
    }
