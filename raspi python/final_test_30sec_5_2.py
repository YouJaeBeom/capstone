            ...
            while True:
                ...
                if check.count(0)==300:
                    ...
                    with conn.cursor() as cursor:
                        ...
                        sql="insert into `Member_sleep_time_30_7` (`ID`,`Time`,`Status`) values (%s,%s,%s)"
                ...
                if cc_hr[30]+5<=cc_hr[0]:
                    print( "30초전 hr",cc_hr[30],"현재 hr",cc_hr[0] )
                    #print("HR 상승")
                ...
                if cc_hr[0]-5<cc_hr[30] and cc_hr[30]<cc_hr[0]+5 :
                    print("30초전 hr",cc_hr[30],"현재 hr",cc_hr[0] )
                    #print("HR 유지")
                ...
                ##########################################################rr
                if cc_rr[30]+2<=cc_rr[0]:
                    print("30초전 rr",cc_rr[30],"현재 rr",cc_rr[0] )
                    #print("RR 상승")
                ...
                if cc_rr[0]-2<cc_rr[30] and cc_rr[30]<cc_rr[0]+2:
                    print("30초전 rr",cc_rr[30],"현재 rr",cc_rr[0] )
                    #print("RR 유지")
                ...
                #######################################################
                    ...
                    if judg_rr=="불규칙" and judg_hr=="증가":
                        ...
                        conn = pymysql.connect(host='dbwo4011.cafe24.com', user='dbwo4011', password='ajswl1234', database='dbwo4011')
                        with conn.cursor() as cursor:
                           sql="insert into `Member_sleep_step_30_5_2` (`ID`,`Time`,`Sleep_step`) values (%s,%s,%s)"
                        ...
                        if flag_ing==0:
                            ...
                            conn = pymysql.connect(host='dbwo4011.cafe24.com', user='dbwo4011', password='ajswl1234', database='dbwo4011')
                            with conn.cursor() as cursor:
                                sql="insert into `Member_sleep_time_30_5_2` (`ID`,`Time`,`Status`) values (%s,%s,%s)"
